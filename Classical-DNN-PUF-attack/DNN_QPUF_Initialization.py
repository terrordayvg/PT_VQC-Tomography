...
def randomTestingData(N,Test): # generating a testing rho based on Qobj identation
    ...
    Penny=[[[0 for k in range(16)] for r in range(16)]for y in range(total_t)]
...
def qnnTraining(qnnArch, initialUnitaries, trainingData, lda, ep, trainingRounds, alert=0):
    ...
    for k in range(trainingRounds):
        ...
        if (k>0):
            #print("Cost:")
            #print(plotlist[1][k],plotlist[1][k-1])

            if (plotlist[1][k]<plotlist[1][k-1]):
                #print(plotlist[1][k]-plotlist[1][k-1])
                break
   ...
   # print(currentUnitaries)
    ...
    print("Output for time-step to stop learning: "+str(k))
    print("")
    print("Plotlist All: ")
    print(plotlist)
    print("--------------------------")
...
if __name__ == "__main__":
    ...
    total_s=10    #Number of Shots training
    total_t=100     #Number of Shots testing
    ...
    plotlist33, unitaries33 = qnnTraining(network33[0], network33[1], network33[2], 1, 0.1, 100,1)
